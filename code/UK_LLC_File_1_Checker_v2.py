...
def check_encoding(filename):
    ...
    with open(filename) as csv_file:
        try:
            ...
            sf.error_output(out_filename, "File Encoding Warning", "File contains unusual characters. Make sure the file is encoded in UTF-8 to avoid potential errors from unrecognised characters: {}".format(0, err))
